...
<div class="all pt-5">
    ...
    <img src="{{asset('img/traffic/B8llMWnBhAt.jpg')}}" alt=""
                        class="img-fluid">
<img src="{{asset('img/traffic/B6DBmbZAN8l.jpg')}}" alt=""
                        class="img-fluid">
<img src="{{asset('img/traffic/BlFmJK-nZ9Q.jpg')}}" alt=""
                        class="img-fluid">
<img src="{{asset('img/traffic/Bm_E41nnhrP.jpg')}}" alt=""
                        class="img-fluid">
