...
<body>
    <div class="all">
        ...
        <div class="home_header">
            <div class="home_header_logo">
                ...
                <div class="small_logo">
                    <img src="{{asset('img/index/logo-1.svg')}}" alt='' >
                </div>
            </div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{asset('img/index/自然美妙天籟.jpg')}}" alt='' width="100%">
                        </div>
                        <div class="swiper-slide">
                            <img src="{{asset('img/index/自然美妙天籟.jpg')}}" alt=''>
                        </div>
                        <div class="swiper-slide"><img src="{{asset('img/index/自然美妙天籟.jpg')}}" alt='' width="100%"></div>
                        <div class="swiper-slide"><img src="{{asset('img/index/自然美妙天籟.jpg')}}" alt='' width="100%"></div>
                    </div>
                    <!-- Add Pagination -->
        ...
        <div class="container ig_container">
            <img src="{{asset('img/index/日出曙光1.jpg')}}" alt=''>
            <img src="{{asset('img/index/日出曙光1.jpg')}}" alt=''>
            <img src="{{asset('img/index/日出曙光1.jpg')}}" alt=''>
            <img src="{{asset('img/index/日出曙光1.jpg')}}" alt=''>
        </div>
