...
<link rel="stylesheet" href="<?php echo e(asset('css/booking_style.css')); ?>">
<style>
    .price_block2 {
        cursor: pointer;
    }
    ...
    <div class="booking_first">
        <div class="booking_first_container col-12 col-md-10 mx-auto container_limit">
            ...
            <div class="booking_first_fig col-12 col-md-10 mx-auto d-flex justify-content-center " data-aos="fade-up"
                ...
                <img width="100%" src="<?php echo e(asset('img/booking/白雪木-1.jpg')); ?>" alt="">
            </div>
        </div>
    </div>
    <!-- 露營 -->
    ...
    <div class="ig_connect  mx-auto container_limit">
        ...
        <div class="ig_connect_row row col-xl-12 col-md-12 col-12 mx-auto  ">
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/B8llMWnBhAt/"><img src="<?php echo e(asset('img/booking/B8llMWnBhAt.jpg')); ?>"
                        alt="" class="img-fluid"></a>

            </div>
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/B6DBmbZAN8l/"><img src="<?php echo e(asset('img/booking/B6DBmbZAN8l.jpg')); ?>"
                        alt="" class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/BlFmJK-nZ9Q/"><img src="<?php echo e(asset('img/booking/BlFmJK-nZ9Q.jpg')); ?>"
                        alt="" class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/Bm_E41nnhrP/"><img src="<?php echo e(asset('img/booking/Bm_E41nnhrP.jpg')); ?>"
                        alt="" class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/B6KRKnIpFNs/"><img src="<?php echo e(asset('img/booking/B6KRKnIpFNs.jpg')); ?>"
                        alt="" class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-xl-2 col-md-4 col-4 my-2">
                <a href="https://www.instagram.com/p/B5wLA4AHbIX/"><img src="<?php echo e(asset('img/booking/B5wLA4AHbIX.jpg')); ?>"
                        alt="" class="img-fluid"></a>
            </div>
...
<?php echo $__env->make('layouts/nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/booking.blade.php ENDPATH**/ ?>