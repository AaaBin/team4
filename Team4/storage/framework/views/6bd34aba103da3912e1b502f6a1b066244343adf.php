...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/firefly_season_style.css')); ?>">
</head>
...
<body>
    ...
    <nav class="nav_pc top-fixed">
        <nav class="nav_pc_content fixed-top pt-4 px-4 d-flex justify-content-between">
            <div class="logo_pc ml-2">
                <a href="/home">
                    <img src="<?php echo e(asset('img/firefly/logo_pc_april.svg')); ?>" alt="logo" style="width: 70%;">
                </a>
            </div>
            ...
            <div class="navbar_pc d-flex align-items-center">
                ...
                <div class="nav_fb ml-5 mr-2">
                    <a href="https://www.facebook.com/springmountain0425931201/">
                        <img src="<?php echo e(asset('img/firefly/logo_facebook.svg')); ?>" alt="link_fb">
                    </a>
                </div>
            </div>
    ...
    <nav class="nav fixed-top">
        <div class="logo_small">
            <a href="#">
                <img src="<?php echo e(asset('img/firefly/logo_small_april.svg')); ?>" alt="logo" height="20px">
            </a>
        </div>
            ...
            <div class="april_banner_text d-flex justify-content-center align-items-center">
                <div class="april_banner_video">
                    ...
                    <video autoplay muted loop id="myVideo">
                        <source src="<?php echo e(asset('video/桐花.mp4')); ?>" type="video/mp4">
                    </video>
                </div>
        ...
        <div class="april_snow">
            <div class="april_snow_content container col-10 d-flex justify-content-between align-items-center">
                ...
                <div class="april_snow_button">
                    <a href="/booking">
                        線上預約
                        <img src="<?php echo e(asset('img/firefly/arrow_right_white.svg')); ?>" alt="" width="19px">
                    </a>
...
<?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/firefly_season.blade.php ENDPATH**/ ?>