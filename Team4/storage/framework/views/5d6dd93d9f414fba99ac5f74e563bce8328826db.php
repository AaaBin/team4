...
<link rel="stylesheet" href="<?php echo e(asset('css/flower_style.css')); ?>">
<style>
...
<div class="flower">
    ...
    <section class="flower_condition_recent mb-5">
        ...
        <?php $__currentLoopData = $flower_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="container d-flex flex-column align-items-center px-md-4 ">
            <h2 class="flower_condition_recent_title my-5 px-3 mb-md-0">
                近期花況
            </h2>
            ...
            ?>
            <div class="flower_condition_recent_date_area position-relative mb-2">
                <div class="flower_condition_recent_date_area_m pr-4"><?php echo e($date_m); ?></div>
                <div class="flower_condition_recent_date_area_d pl-4"><?php echo e($date_d); ?></div>
            </div>
            <article class="flower_condition_recent_content">
    ...
    <section class="flower_condition_old">
        ...
        <div class="container d-flex flex-column align-items-center justify-content-center mb-5 px-3 px-md-4">
            <div class="flower_condition_old_date_area position-relative mb-2">
                <div class="flower_condition_old_date_area_m pr-4"><?php echo e($date_m); ?></div>
                <div class="flower_condition_old_date_area_d pl-4"><?php echo e($date_d); ?></div>
            </div>
...
<script>
    fetch('https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-075?Authorization=CWB-908DFEE0-69E2-43D0-8D23-6CD50BB2FCDE&locationName=%E6%96%B0%E7%A4%BE%E5%8D%80')
        ...
        .then(function (weather_data_sevendays_all) {
            ...
            if (Wx_code_1 == '01'){
            var weather_icon_1 = '<?php echo e(asset("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_1 == '02'|| Wx_code_1 == '03' || Wx_code_1 == '04'){
            var weather_icon_1 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_1 == '05'|| Wx_code_1 == '06' || Wx_code_1 == '07'){
            var weather_icon_1 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_1 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };

        if (Wx_code_2 == '01'){
            var weather_icon_2 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_2 == '02'|| Wx_code_2 == '03' || Wx_code_2 == '04'){
            var weather_icon_2 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_2 == '05'|| Wx_code_2 == '06' || Wx_code_2 == '07'){
            var weather_icon_2 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_2 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };


        if (Wx_code_3 == '01'){
            var weather_icon_3 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_3 == '02'|| Wx_code_3 == '03' || Wx_code_3 == '04'){
            var weather_icon_3 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_3 == '05'|| Wx_code_3 == '06' || Wx_code_3 == '07'){
            var weather_icon_3 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_3 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };

        if (Wx_code_4 == '01'){
            var weather_icon_4 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_4 == '02'|| Wx_code_4 == '03' || Wx_code_4 == '04'){
            var weather_icon_4 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_4 == '05'|| Wx_code_4 == '06' || Wx_code_4 == '07'){
            var weather_icon_4 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_4 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };


        if (Wx_code_5 == '01'){
            var weather_icon_5 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_5 == '02'|| Wx_code_5 == '03' || Wx_code_5 == '04'){
            var weather_icon_5 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_5 == '05'|| Wx_code_5 == '06' || Wx_code_5 == '07'){
            var weather_icon_5 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_5 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };


        if (Wx_code_6 == '01'){
            var weather_icon_6 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_6 == '02'|| Wx_code_6 == '03' || Wx_code_6 == '04'){
            var weather_icon_6 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_6 == '05'|| Wx_code_6 == '06' || Wx_code_6 == '07'){
            var weather_icon_6 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_6 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };

        if (Wx_code_7 == '01'){
            var weather_icon_7 = '<?php echo e(("img/flower/flower_weather_cloud_sunnny.png")); ?>'
        } else if(Wx_code_7 == '02'|| Wx_code_7 == '03' || Wx_code_7 == '04'){
            var weather_icon_7 = '<?php echo e(asset("img/flower/flower_weather_cloud_sun.png")); ?>'
        }else if(Wx_code_7 == '05'|| Wx_code_7 == '06' || Wx_code_7 == '07'){
            var weather_icon_7 = '<?php echo e(asset("img/flower/flower_weather_cloudy.png")); ?>'
        }else{
            var weather_icon_7 = '<?php echo e(asset("img/flower/flower_weather_rain.png")); ?>'
        };
...
<?php echo $__env->make('layouts/nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/flower.blade.php ENDPATH**/ ?>