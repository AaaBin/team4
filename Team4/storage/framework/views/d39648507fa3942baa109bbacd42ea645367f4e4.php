...
<link rel="stylesheet" href="<?php echo e(asset('css/traffic_style.css')); ?>">
            ...
            <div class="row ">
                ...
                <div class="block_left col-4">
                    <a href="http://www.fybus.com.tw/bus8.htm">
                        <img src="<?php echo e(asset('img/traffic/bus_icon_F.svg')); ?>" alt="豐原客運時刻表" class="mb-4" width="70%">
                    </a>
                    <p>豐原客運時刻表</p>
                </div>
                <div class="block_right col-4">
                    ...
                    <a href="http://www.ubus.com.tw/upload/citybusmap/taichung/map/31L.jpg">
                        <img src="<?php echo e(asset('img/traffic/bus_icon_T.svg')); ?>" alt="統聯客運時刻表" class="mb-4" width="70%">
                    </a>
                    <p>統聯客運時刻表</p>
        ...
        <div class="section_zhongxingling col-8 mx-auto">
            <div class="row ">
                ...
                <div class="block_left col-2 col-4">
                    <img src="<?php echo e(asset('img/traffic/small_bus_icon.svg')); ?>" alt="中興嶺站轉乘" width="60%">
                ...
                <div class="block_right col-4 col-lg-5">
                    ...
                    <p>0910-956-339</p>
                    <a href="">
                        <img width="30" src="<?php echo e(asset('img/traffic/FB_icon.svg')); ?>" alt="FB_icon" class="mr-2">
                    </a>
                    <a href="">
                        <img width="30" src="<?php echo e(asset('img/traffic/mail_icon.svg')); ?>" alt="mail_icon">
                    </a>
    ...
    <div class="ig_connect mx-auto">
        ...
        <div class="ig_connect_row row col-md-10 col-12 mx-auto ">
            <div class="ig_connect_fig col-md-2 col-4">
                <a href="https://www.instagram.com/p/B8llMWnBhAt/"><img src="<?php echo e(asset('img/traffic/B8llMWnBhAt.jpg')); ?>" alt=""
                        class="img-fluid"></a>

            </div>
            <div class="ig_connect_fig col-md-2 col-4">
                <a href="https://www.instagram.com/p/B6DBmbZAN8l/"><img src="<?php echo e(asset('img/traffic/B6DBmbZAN8l.jpg')); ?>" alt=""
                        class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-md-2 col-4">
                <a href="https://www.instagram.com/p/BlFmJK-nZ9Q/"><img src="<?php echo e(asset('img/traffic/BlFmJK-nZ9Q.jpg')); ?>" alt=""
                        class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-2 d-none d-md-block">
                <a href="https://www.instagram.com/p/Bm_E41nnhrP/"><img src="<?php echo e(asset('img/traffic/Bm_E41nnhrP.jpg')); ?>" alt=""
                        class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-2 d-none d-md-block">
                <a href="https://www.instagram.com/p/B6KRKnIpFNs/"><img src="<?php echo e(asset('img/traffic/B6KRKnIpFNs.jpg')); ?>" alt=""
                        class="img-fluid"></a>
            </div>
            <div class="ig_connect_fig col-2 d-none d-md-block">
                <a href="https://www.instagram.com/p/B5wLA4AHbIX/"><img src="<?php echo e(asset('img/traffic/B5wLA4AHbIX.jpg')); ?>" alt=""
                        class="img-fluid"></a>
            </div>
...
<?php echo $__env->make('layouts/nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/traffic.blade.php ENDPATH**/ ?>