...
<div class="all pt-5">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('img/home/自然美妙天籟.jpg')); ?>" alt="" width="100%">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo e(asset('img/home/油桐花4.jpg')); ?>" alt="">
                    </div>
                    <div class="swiper-slide"><img src="<?php echo e(asset('img/home/金針花-1.jpg')); ?>" alt="" width="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(asset('img/home/白雪木.jpg')); ?>" alt="" width="100%"></div>
                </div>
                <!-- Add Pagination -->
    ...
    <div class="container ig_container" data-aos="fade-up" data-aos-duration="3000">
        <img src="<?php echo e(asset('img/home/B6KRKnIpFNs.jpg')); ?>" alt="">
        <img src="<?php echo e(asset('img/home/B6P9pnJgaZE.jpg')); ?>" alt="">
        <img src="<?php echo e(asset('img/home/B8llMWnBhAt.jpg')); ?>" alt="">
        <img src="<?php echo e(asset('img/home/Bm_E41nnhrP.jpg')); ?>" alt="">
    </div>
...
<?php echo $__env->make('layouts/nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/home.blade.php ENDPATH**/ ?>