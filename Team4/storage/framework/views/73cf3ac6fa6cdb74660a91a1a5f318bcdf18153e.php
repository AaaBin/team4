...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/nav/logo_PC.svg')); ?>">
...
<body>
    ...
    <nav class="nav_pc">
        <nav class="nav_pc_content fixed-top pt-2 px-4 d-flex justify-content-between">
            <div class="logo_pc ml-2">
                <a href="/home">
                    <img src="<?php echo e(asset('img/nav/logo_PC.svg')); ?>" alt="logo" style="width: 70%;">
                </a>
            </div>
            ...
            <div class="navbar_pc d-flex align-items-center">
                ...
                <div class="nav_fb ml-5 mr-2">
                    <a href="https://www.facebook.com/springmountain0425931201/">
                        <img src="<?php echo e(asset('img/nav/logo_facebook.svg')); ?>" alt="link_fb">
                    </a>
                </div>
            </div>
    ...
    <nav class="nav fixed-top">
        <div class="logo_small">
            <a href="#">
                <img src="<?php echo e(asset('img/nav/logo_small.svg')); ?>" alt="logo">
            </a>
        </div>
...
<?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views/layouts/nav.blade.php ENDPATH**/ ?>