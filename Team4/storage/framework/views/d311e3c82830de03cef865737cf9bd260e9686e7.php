...
<link rel="stylesheet" href="<?php echo e(asset('css/activity_style.css')); ?>">
    ...
    <section class="activity_section row" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="350">
        ...
        <div class="activity_card col-6 col-md-3 d-flex align-items-center flex-column mb-5 pb-2">
            <div class="activity_img d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/activity/seasons_CherryBlossom.svg')); ?>">
        ...
        <div class="activity_card col-6 col-md-3  d-flex align-items-center flex-column mb-5 pb-2">
            <div class="activity_img d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/activity/seasons_tung.svg')); ?>">
                <div class="img_back"></div>
            </div>
            <h2>四至五月</h2>
        ...
        <div class="activity_card col-6 col-md-3  d-flex align-items-center flex-column mb-5 pb-2">
            <div class="activity_img d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/activity/seasons_lily.svg')); ?>">
                <div class="img_back"></div>
            </div>
        ...
        <div class="activity_card col-6 col-md-3  d-flex align-items-center flex-column mb-5 pb-2">
            <div class="activity_img d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/activity/seasons_snow.svg')); ?>">
                <div class="img_back"></div>
            </div>
...
<?php echo $__env->make('layouts/nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\GitHub\team4\Team4\resources\views//front/activity.blade.php ENDPATH**/ ?>